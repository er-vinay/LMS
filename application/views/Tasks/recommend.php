                                        ...
                                        <div class="login-formmea">
                                            <div class="box-widget widget-module">
                                                <div class="widget-head clearfix">
                                                    ...
                                                    <h4>Leads Recommend</h4>
                                                    <div class="head"> 
                                                        <span class="counter"><?= $recommend->num_rows(); ?></span>
                                                    </div>
                                                </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="scroll_on_x_axis table-responsive">
                                                                <table class="table dt-table table-striped table-bordered table-responsive table-hover" style="border: 1px solid #dde2eb">
                                                                    ...
                                                                    <tbody>
                                                                        <?php $i = 1; foreach($recommend->result() as $row) : ?>
                                                                        <tr class="table-default">
                                                                            ...
                                                                            <td><?= $row->source; ?></td> 
                                                                            <td><?php echo $status = ($row->status == "" ? "IN PROGRESS" : "IN PROGRESS"); ?></td>
