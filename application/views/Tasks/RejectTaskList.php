                                        ...
                                        <div class="login-formmea">
                                            <div class="box-widget widget-module">
                                                <div class="widget-head clearfix">
                                                    ...
                                                    <h4>Leads Rejected</h4>
                                                    <div class="head"> 
                                                        <span class="counter"><?= $rejectedLists->num_rows(); ?></span>
                                                    </div>
                                                </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="scroll_on_x_axis table-responsive">
                                                                <table class="table dt-table table-striped table-bordered table-responsive table-hover" style="border: 1px solid #dde2eb">
                                                                    ...
                                                                    <tbody>
                                                                        <?php $i = 1; foreach($rejectedLists->result() as $row) : ?>
                                                                        <tr class="table-default">
                                                                            ...
                                                                            <td>
                                                                                ...
                                                                                <!-- <a href="#" onclick="viewLeadsRejectedDetails('<?= $row->lead_id; ?>')" data-toggle="modal" data-target="#myModal"><i class="fa fa-pencil-square-o"></i></a> -->
                                                                            </td>
                                                                            <td></td>
...
<script>
    function viewLeadsRejectedDetails(lead_id){
        $.ajax({
            url : '<?= base_url("rejectedLeadDetails/") ?>'+lead_id,
            type : 'POST',
            dataType : "json",
            async: false,
