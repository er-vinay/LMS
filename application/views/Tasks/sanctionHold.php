                                        ...
                                        <div class="login-formmea">
                                            <div class="box-widget widget-module">
                                                <div class="widget-head clearfix">
                                                    ...
                                                    <h4>Hold</h4>
                                                    <div class="head">
                                                        <span class="counter"><?= $taskCount; ?></span>
                                                    </div>
                                                    ...
                                                    <div class="download">
                                                        ...
                                                        <!--<a href="#">SELECT</a>-->
                                                        <!--<a href="#">SHOW</a>-->
                                                        <!--<a  class="btn" id="checkDuplicateItem">Add To Duplicate List</a>-->
                                                    </div>
                                                </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="scroll_on_x_axis table-responsive">
                                                                ...
                                                                <table class="table dt-table table-striped table-bordered table-hover" data-order='[[ 0, "desc" ]]' style="border: 1px solid #dde2eb">
                                                                    ...
                                                                    <tbody>
                                                                        <?php foreach($sanctionHold as $row) : ?>
                                                                        <tr>
                                                                            <td style="width : auto;">
                                                                                <input type="checkbox" name="duplicate_id[]" class="duplicate_id" id="duplicate_id" value="<?= $row->lead_id; ?>">&nbsp;
                                                                                <?= $row->lead_id; ?>
            ...
            $.ajax({
                ...
                success : function(response) {
                    if(response == "true"){
                        ...
                        $(".msg a").html("Loan Rejected Successfully.");
                        $('#reson').empty();
