                                        ...
                                        <div class="login-formmea">
                                            <div class="box-widget widget-module">
                                                <div class="widget-head clearfix">
                                                    ...
                                                    <h4>Leads In Process</h4>
                                                    <div class="head"> 
                                                        <span class="counter"><?= $inProcess->num_rows(); ?></span>
                                                    </div>
                                                </div>
                                                                ...
                                                                <table class="table dt-table table-striped table-bordered table-responsive table-hover" style="border: 1px solid #dde2eb">
                                                                    <thead>
                                                                        <tr>
                                                                            ...
                                                                            <th><b>Source</b></th>
                                                                            <th><b>Status</b></th>
                                                                            <th><b>Intiated On</b></th>
                                                                        </tr>
                                                                    </thead>
                                                                    <tbody>
                                                                        <?php $i = 1; foreach($inProcess->result() as $row) : ?>
                                                                        <tr class="table-default">
                                                                            ...
                                                                            <td><?= $row->source; ?></td>
                                                                            <td><?php echo $status = ($row->status == "" ? "IN PROCESS" : "IN PROCESS"); ?></td> 
