                        ...
                        <div class="tab" role="tabpanel">
                            <ul class="nav nav-tabs" role="tablist">
                                ...
                                <?php if($_SESSION['isUserSession']['role'] == creditManager 
                                    || $_SESSION['isUserSession']['role'] == headCreditManager
                                    || $_SESSION['isUserSession']['role'] == admin
                                    || $_SESSION['isUserSession']['role'] == teamDisbursal 
                                    || $url == "search"){ ?>
                                ...
                                <?php } if($_SESSION['isUserSession']['role'] == teamDisbursal 
                                    || $_SESSION['isUserSession']['role'] == admin 
                                    || $url == "search"){ ?>
                            ...
                            <div class="tab-content tabs">
                                <div role="tabpanel" class="tab-pane fade in active" id="LeadSaction">
                                    ...
                                    <div id="cibil_details" class="collapse">
                                        <?php if($_SESSION['isUserSession']['role'] == screener 
                                            || $_SESSION['isUserSession']['role'] == creditManager
                                            || $_SESSION['isUserSession']['role'] == admin) : ?>
