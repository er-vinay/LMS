		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-md-6 col-md-offset-3">
					<div class="form">
						<form method="post" action="<?= base_url('generatePassword');?>" id="formData" autocomplete="off">
							<p class="text-center">
							...
							<div class="form-group">
                                <p class="text-center">
                                    <span style="color : red; font-size : 20px;">*</span>New Password
                                </p>
								<input type="text" name="password" class="form-control" placeholder="Password" title="Password" required>
							</div>
							<div class="form-group">
								<button class="form-control" id="userSigin" title="New Password">Create</button>
							</div>
						</form>
						<p class="text-center"><a href="<?= base_url('logout') ?>">LOG IN</a></p>
					</div>
				</div>
			</div>
		</div>
