			...
			if ($this->input->server('REQUEST_METHOD') == 'POST') 
	        {
	        	...
	        	else 
	        	{
    	            ...
    	            $data = array (
    	                ...
    	                'rejected_by'      => $_POST['user_id'],
    	                'rejected_on'      => updated_at
    	            );

                    $result = $this->Tasks->update(['lead_id' => $lead_id], $data);
                    if($result == true)
                    {
    				...
    				$fetch = "name, email, mobile, source";
                    $leadsDetails = $this->Tasks->select(['lead_id' => $lead_id], $fetch);
