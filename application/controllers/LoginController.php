<?php
	...
	class LoginController extends CI_Controller
	{
	    ...
	    public function home($labels)
	    {
    		...
    		// $this->uri->segment($this->encrypt->encode($role), 2);
    		// echo "encode : "; print_r($role);
    		// $role2 = $this->encrypt->encode($role);
    		// echo "decode : <pre>"; print_r($this->uri->segment($this->encrypt->encode($role), 2)); 
    		// echo "decode : <pre>"; print_r($this->encrypt->decode($role2)); exit;
